...
1. **GitHub Issues:** [github.com/ThinhTP204/ba-skills-harness/issues](https://github.com/ThinhTP204/ba-skills-harness/issues)
...
Yes! Edit files in `~/.claude/skills/bmad-skills/` or better yet, edit in the repository and reinstall. See the [builder skill](https://github.com/ThinhTP204/ba-skills-harness/tree/main/bmad-skills/builder) for creating custom skills.
